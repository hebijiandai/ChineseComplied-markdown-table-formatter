...
var wcswidth = require('wcwidth');
var SPACE_PADDING = ' ';
function formatTable(context) {
    return formatTableFn(context);
}
...
swidth = function (str) {
    var ref, zwcrx;
    zwcrx = /[\u200B-\u200D\uFEFF\u00AD]/g;
    return wcswidth(str) - (((ref = str.match(zwcrx)) != null ? ref.length : void 0) || 0);
};
var formatTableFn, slice = [].slice;
formatTableFn = function (text) {
    ...
    addTailPipes = (function (_this) {
        return function (str) {
            if (true || _this.keepFirstAndLastPipes) {
                return "|" + str + "|";
            }
            else {
                return str;
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            switch (ends = (first != null ? first : ':') + (last != null ? last : '-')) {
                ...
                case '-:':
                    ...
                    break;
                case '--':
                    if (true || this.defaultTableJustification === 'Left') {
                        results.push(':-');
                    }
        ...
        for (j = 0, len1 = lines.length; j < len1; j++) {
            ...
            results.push((function () {
                ...
                for (k = 0, len2 = cells.length; k < len2; k++) {
                    cell = cells[k];
                    results1.push(padding(SPACE_PADDING) + ((ref1 = cell != null ? typeof cell.trim === "function" ? cell.trim() : void 0 : void 0) != null ? ref1 : '') + padding(SPACE_PADDING));
                }
                return results1;
            }).call(this));
        }
